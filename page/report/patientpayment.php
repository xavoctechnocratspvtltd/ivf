...
class page_report_patientpayment extends \xepan\base\Page{
	public $title = "Patient Payment Report";
	...
	function init(){
		...
		$col2->add('View')->setElement('h2')->set('Patinet Payment growth Chart');
